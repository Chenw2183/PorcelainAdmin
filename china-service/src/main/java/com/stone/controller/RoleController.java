...
public class RoleController {
     ...
     *
     */
    @RequestMapping(value = "/updateByIds")
    public void updateByIds(@RequestBody CmRole cmRole) {
        cmRoleService.updateByIds(cmRole);
    }
    ...
    public Page<CmRole> addRole(@RequestBody CmRoleCompetence cmRoleCompetence) {
    ...
    public List<CmMenu> selectMenuAll() {
        return cmRoleService.selectCmmenu();
    }
